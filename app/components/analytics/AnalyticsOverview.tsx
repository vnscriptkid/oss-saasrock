  ...
  return (
    <div className="space-y-2 text-gray-800">
      <dl className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
        {authenticated ? (
          <>
            <Link to="visitors" className="overflow-hidden rounded-lg bg-white px-4 py-3 shadow hover:bg-gray-50">
            ...
            <Link to="page-views" className="overflow-hidden rounded-lg bg-white px-4 py-3 shadow hover:bg-gray-50">
            ...
            <Link to="events" className="overflow-hidden rounded-lg bg-white px-4 py-3 shadow hover:bg-gray-50">
